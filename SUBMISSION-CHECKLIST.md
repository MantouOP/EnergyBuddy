...
- [ ] Team name
- [ ] Full member names
- [ ] Genuine mentor name, consultation date and feedback
- [ ] Final public GitHub repository URL
- [ ] Final unlisted YouTube URL
...
- [ ] Replace mentor placeholder with genuine evidence

## Prototype and design

- [x] Today screen
- [x] Three energy batteries
...
## Technical and impact

- [x] Technology choices and constraints
- [x] Architecture diagram
- [x] Explainable forecast model
- [x] Prioritised build scope
- [x] Explicit out-of-scope list
- [x] Before/after impact scenario
- [x] Responsible-use boundary
